                ...
                <div x-data="{ openCreate: false }" class="flex flex-col lg:flex-row items-center justify-between gap-4">
                        ...
                        <div class="bg-white rounded-lg p-6 w-full max-w-lg max-h-[80vh] overflow-y-auto">
                            ...
                            <form method="POST" action="{{ route('dashboard.user.store') }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <x-forms.select name="role" label="Role Pengguna"
                                        :options="['Admin']"></x-forms.select>
                    ...
                    <form method="GET" action="{{ route('dashboard.user.index') }}"
                        ...
                        <div class="w-full lg:w-80">
                            <x-forms.input type="text" name="search" placeholder="Cari nama atau email user..."
                ...
                <tbody class="divide-y divide-gray-300">
                    @forelse($users as $user)
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="p-2 border-r border-gray-300 whitespace-nowrap">{{ $user->name }}</td>
                            <td class="p-2 border-r border-gray-300 whitespace-nowrap">{{ $user->email }}</td>
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                                        <x-forms.input name="name" label="Nama"
                                                            :value="old('name', $user->name)"></x-forms.input>
                                                        <x-forms.select name="role" label="Role Pengguna"
                                                            :options="['Admin']" :selected="old('role', $user->role)"></x-forms.select>
                                                        <x-forms.input name="email" label="Email" type="email"
                                                            :value="old('email', $user->email)"></x-forms.input>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="p-4 text-center text-gray-500">Tidak ada data user</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
